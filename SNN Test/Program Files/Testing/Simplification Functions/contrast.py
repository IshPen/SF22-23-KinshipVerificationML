...
def adjust_contrast_brightness_ui(image):
    ...
    while True:
        ...
        contrast_factor = contrast_factor / 100.0
        brightness_factor = brightness_factor / 100.0
...
# Load an image
image = cv2.imread(r'D:\Programs\Program Files\Pycharm Projects\SF22-23-KinshipVerificationML\Data\scienceFairRawFacesNOBG\noBGface5.jpg')
