...
def triangulation(img):
  #init image
  #we don't need the below line because we're importing an image that's already been read by cv2
...
if __name__ == "__main__":
    out1 = triangulation("noBGface9.jpg")
    out2 = triangulation("noBGface2228.jpg")
