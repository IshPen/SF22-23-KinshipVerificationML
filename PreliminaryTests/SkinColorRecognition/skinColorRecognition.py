### CODE BY OCTALPIXEL ON GITHUB ###
#https://medium.com/@mithushancj/skin-segmentation-and-dominant-tone-color-extraction-fe158d24badf
import numpy as np
import cv2
...
imgURL = "https://raw.githubusercontent.com/octalpixel/Skin-Extraction-from-Image-and-Finding-Dominant-Color/master/82764696-open-palm-hand-gesture-of-male-hand_image_from_123rf.com.jpg"
...
image=cv2.imread("face15.jpg")
#image = imutils.url_to_image(imgURL)
